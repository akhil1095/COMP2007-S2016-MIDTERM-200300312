<%@ Page Title="Todo Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TodoDetails.aspx.cs" Inherits="COMP2007_S2016_MidTerm_2003003121.TodoDetails" %>
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" TextMode="MultiLine" CssClass="form-control" ID="NotesTextBox" placeholder="Todo Notes" required="true"></asp:TextBox>
                </div>
                <div class="form-group">
